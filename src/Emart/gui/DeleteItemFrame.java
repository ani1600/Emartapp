...
public class DeleteItemFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtProductDetails1 = new javax.swing.JTable();
        ...
        jtProductDetails1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane2.setViewportView(jtProductDetails1);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        int row=jtProductDetails1.getSelectedRow();
        if(row==-1){
           JOptionPane.showMessageDialog(null,"No product selected to delet","No product Selected",JOptionPane.ERROR_MESSAGE);
                return; 
        }
        ...
        try{
            if(ProductsDAO.deleteProduct(pid)){
                ...
                tm.setRowCount(0);//so that when loadProductDetails method works before that the table becomes empty.
                loadProductDetails();
                return;
            }
    ...
    private javax.swing.JTable jtProductDetails1;
    ...
    try{
            ...
            tm=(DefaultTableModel)jtProductDetails1.getModel();
